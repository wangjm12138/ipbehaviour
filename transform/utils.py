...
class MyLogger(object):
	...
	def __init__(self, name="logger", level=logging.DEBUG, console_level=logging.INFO, mode='a',config=None,update=False):
		...
		if update:
			logFile = os.path.join(log_path_str, date_time + '_update.log')
		else:
